                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-body">
                            <h4 class="m-b-30 m-t-0">Registration fee</h4>
                            <div class="row">
                                                ...
                                                <table class="table table-primary mb30 table-hover table-bordered">
                                                    <thead>
                                                        <tr role="row">
                                                            ...
                                                            <th class="col-col-3 text-center">Action</th>
                                                    ...
                                                    <tbody>
                                                            ...
                                                            <tr role="row" class="odd">
                                                                 ...
                                                                 <td><span class="pull-right"><?php echo $this->config->item('currency_icon') ?>&nbsp;<?php echo $Rewardsdata['registration_fee']; ?></span></td>
                                                                
                                                                <td class="text-center">
                                                                    <a href="#editmodal" title="Edit" id="edit_btn" data-toggle="modal" onclick="edit_rewards('<?php echo base64_encode($Rewardsdata['admin_id']); ?>');"> <i class="glyphicon glyphicon-edit"></i></a>
...
<script type="text/javascript">
    ...
    function edit_rewards(id)
    {
        ...
        $('#model_data').html('');
        $.ajax({
            url: "<?php echo site_url() . 'Fixpayment/update' ?>",
            type: "POST",
            dataType: "html",
            data: {'<?php echo $this->security->get_csrf_token_name(); ?>': '<?php echo $this->security->get_csrf_hash(); ?>', 'pay_id': pay_id, },
            catch : false,
