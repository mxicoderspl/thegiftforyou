...
<div class="content">
    <div class="">
        <div class="page-header-title">
            <h4 class="page-title">Company wallet</h4>
        </div>
    </div>
    <div class="page-content-wrapper ">
        <div class="container">
            ...
            <div class="row">
				...
				<div class="row">
                               ...
                               <select name="selUser" id="selUser" class=" form-control " style="width:100%;">
                                   <option id="sele" value="">Please select user</option>
			...
			<div class="col-sm-3">
                        <div class="form-group">
                            <button type="button" class="btn btn-primary" onclick="ff()" >Generate Balance Sheet</button></a>
                       </div>
                    </div>
                </div>
                            <div class="row">
...
<script type="text/javascript">
     function ff(){
       ...
       if(user_id != null && user_id != ''){
         ...
         $('#selUser').css('color', 'red');
          //$('#selUser').find('option').css('background-color', 'red');
          //location.reload();
    ...
    function load_data(){
        var table = jQuery('#datatables').DataTable({
            ...
            "order": [[0, "DESC"]],
            "ajax": {
                url: "<?php echo site_url('Wallettransaction/getgrdUserData'); ?>",
                 type: "GET",
                data: function (d) {
