    ...
    <div class="page-content-wrapper ">
        <div class="container">
            ...
            <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-primary">
                            <div class="panel-body">
                                <h4 class="m-b-30 m-t-0">Add New Business Service</h4>
				...
				<input type="hidden" name="userid" id="userid" value="<?php echo $user_info[0]['id'];?>"/>
                                <div class="col-md-10 col-xs-12  padngrmv-input">
                                    ...
                                    <div class="form-group col-xs-12 padng_rmv">
                                        ...
                                        <div class="col-md-9 col-xs-12 padngrmv-input">
                                            <input type="text" class="form-control" id="email" name="email" placeholder="Email" value="<?php echo $user_info[0]['email'];?>" >
                                        </div>   
                                    </div>
                                    <div class="form-group col-xs-12 padng_rmv">
				...
				<div class="form-group col-xs-12 padng_rmv">
                                ...
                                <div class="col-md-10 col-xs-12">
                                    ...
                                    <div class="form-group col-xs-12 padng_rmv">
                                        ...
                                        <div class="col-md-9 col-xs-12 padngrmv-input">
                                            <input type="text" class="form-control " id="city" name="city" placeholder="City" value="<?php // echo $login_business_info['city'];            ?>" readonly>
                                        </div>   
                                    </div>
                                    <div class="form-group col-xs-12 padng_rmv">
					...
					<select class="form-control" id="states" name="states">
                                                ...
                                                <?php foreach ($state as $state): ?>
                                                    <option <?php // echo ($login_business_info['country'] == $country['id']) ? 'selected' : '';            ?> value="<?php echo $state['id']; ?>"><?php echo $state['name']; ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>   
                                    </div>
