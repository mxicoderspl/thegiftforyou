...
<div class="content">
    <div class="">
        <div class="page-header-title">
            <h4 class="page-title">Add New Business Service</h4>
        </div>
    </div>
            ...
            <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-primary">
                            <div class="panel-body">
                                <h4 class="m-b-30 m-t-0">Edit Business Service</h4>
                            <?php echo form_open_multipart(site_url('Service/update_business'), array('class' => '', 'id' => 'profilefrm', 'name' => 'profilefrm', 'method' => 'POST', 'enctype' => 'multipart/form-data')); ?>
                            <div class="col-md-12" id="ContactDetail">
                                <!--<h2 class="col-xs-12 padng_rmv">Enter Contact Information Below</h2>-->
				<input type="hidden" name="userid" id="userid" value="<?php echo $business_info[0]['user_id'];?>"/>
                                <div class="col-md-10 col-xs-12  padngrmv-input">
                                    ...
                                    <div class="form-group col-xs-12 padng_rmv">
                                        ...
                                        <div class="col-md-9 col-xs-12 padngrmv-input">
                                            <input type="text" class="form-control" id="businessname" name="businessname" placeholder="Business Name" value="<?php echo $business_info[0]['businessname']; ?>"/>
                                        </div>   
                                    </div>
                                    <div class="form-group col-xs-12 padng_rmv">
                                        ...
                                        <div class="col-md-9 col-xs-12 padngrmv-input">
                                            <select id="business_type" name="business_type" class="form-control">
                                                ...
                                                <?php foreach ($business_type as $type): ?>
                                                    <option <?php echo ($business_info[0]['business_type'] == $type['id'])?'selected' : ''?> value="<?php echo $type['id']; ?>"><?php echo $type['type_name']; ?></option>
                                                <?php endforeach; ?>
                                            </select>  
                                        </div>   
                                    </div>
                                    <div class="form-group col-xs-12 padng_rmv">
                                        ...
                                        <div class="col-md-9 col-xs-12 padngrmv-input">
                                            <input type="text" class="form-control" id="ownername" name="ownername" placeholder="Business Owner Name" value="<?php  echo $business_info[0]['ownername'];?>">
                                        </div>   
                                    </div>
                                    <div class="form-group col-xs-12 padng_rmv">
                                        <label for="Email" class="col-md-3 col-xs-12 lb1 padngrmv-input"><span style="color: red">*</span>Email<span id="verifiedemail">
                                                <?php
                                                //if ($user_info[0]['active_email'] == 'No') {
                                        ...
                                        <div class="col-md-9 col-xs-12 padngrmv-input">
                                            <input type="text" class="form-control" id="email" name="email" placeholder="Email" value="<?php echo $business_info[0]['email'];?>" readonly>
                                        </div>   
                                    </div>
                                    <div class="form-group col-xs-12 padng_rmv">
                                        <label for="phone" class="col-md-3 col-xs-12 lb1 padngrmv-input"><span style="color: red">*</span>Phone Number</label>
                                        <div class="col-md-9 col-xs-12 padngrmv-input">
                                            <input type="text" class="form-control" id="phone" name="phone" placeholder="Phone Number" maxlength="10" value="<?php echo $business_info[0]['phone'];?>"/>
                                        </div>   
                                    </div>
				...
				<div class="form-group col-xs-12 padng_rmv">
					...
					<div class="col-md-3 col-xs-12">
						<img src="<?php echo base_url() . $this->config->item('upload_path_business_thumb'). $business_info[0]['image']?>" style="height:62px;width:82px"/>					
					</div>
                                    </div>
                                    <div class="form-group col-xs-12">
                                        <label class="col-md-3 col-xs-12 control-label">Write Something about Your Business</label>
                                        <div class="col-md-9 col-xs-12">
                                            <textarea  class="form-control" name="about" id="about"><?php echo $business_info[0]['description'];?></textarea>
                                ...
                                <div class="col-md-10 col-xs-12">
                                    ...
                                    <div class="form-group col-xs-12 padng_rmv">
                                        ...
                                        <div class="col-md-9 col-xs-12 padngrmv-input">
                                            <input type="text" class="form-control " id="geolocation" name="geolocation" placeholder="Enter Lat-long" value="<?php echo $business_info[0]['geolocation'];?>">
                                    ...
                                    <div class="form-group col-xs-12 padng_rmv">
                                        ...
                                        <div class="col-md-9 col-xs-12 padngrmv-input">
                                            <input type="text" class="form-control " id="addressline1" name="addressline1" placeholder="Address Line 1" value="<?php echo $business_info[0]['addressline1'];?>">
                                        </div>   
                                    </div>
                                    <div class="form-group col-xs-12 padng_rmv">
                                        <label for="addressline2" class="col-md-3 col-xs-12 lb1 padngrmv-input">Address Line 2</label>
                                        <div class="col-md-9 col-xs-12 padngrmv-input">
                                            <input type="text" class="form-control " id="addressline2" name="addressline2" placeholder="Address Line 2" value="<?php echo $business_info[0]['addressline2'];?>">Optional
                                        </div>   
                                    </div>
                                    <div class="form-group col-xs-12 padng_rmv">
                                        <label for="city" class="col-md-3 col-xs-12 lb1 padngrmv-input"><span style="color: red">*</span>City</label>
                                        <div class="col-md-9 col-xs-12 padngrmv-input">
                                            <input type="text" class="form-control " id="city" name="city" placeholder="City" value="<?php echo $business_info[0]['city'];?>" readonly>
                                        </div>   
                                    </div>
                                    <div class="form-group col-xs-12 padng_rmv">
					...
					<select class="form-control" id="states" name="states">
                                                ...
                                                <?php foreach ($state as $state): ?>
                                                    <option <?php echo ($business_info[0]['state'] == $state['id']) ? 'selected' : '';            ?> value="<?php echo $state['id']; ?>"><?php echo $state['name']; ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>   
                                    </div>
                                    <div class="form-group col-xs-12 padng_rmv">
                                        ...
                                        <div class="col-md-9 col-xs-12 padngrmv-input">
                                             <input type="text" class="form-control "   placeholder="Country"                                       id="country" name="country" readonly value="<?php echo $business_info[0]['countryname']?>"></input>
                                    ...
                                    <div class="form-group col-xs-12 padng_rmv">
                                        ...
                                        <div class="col-md-9 col-xs-12 padngrmv-input">
                                            <input type="text" class="form-control " id="zipcode" name="zipcode" placeholder="Zip Code" value="<?php echo $business_info[0]['zipcode']?>">
                                        </div>   
                                    </div>
                            ...
                            <div id="Aboutbusiness" >
                                ...
                                <button type="submit" class="btn btn-primary pull-right" style="margin-right:195px">Update</button> 
                               <!-- <button type="button" class="btn btn-default" id="back">Back</button> -->
				<a class="btn btn-default pull-right m-r-15" href="<?php echo site_url('Service');?>">Cancel</a>
                            </div>
