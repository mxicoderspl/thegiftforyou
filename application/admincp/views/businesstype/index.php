                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-body">
                            <h4 class="m-b-30 m-t-0">Business Types
				<a href="#addmodal" class="btn btn-primary pull-right" title="Add" id="add_btn" data-toggle="modal" onclick="add_business_type();"> Add<i class="glyphicon glyphicon-Add"></i></a>				
				</h4>
                                                            ...
                                                            <tr role="row" class="odd">
                                                               ...
                                                               <!-- <td><?php echo $sdata['link']; ?></td>-->
                                                                ...
                                                                <td class="text-center">
                                                                    <a href="#editmodal" title="Edit" id="edit_btn" data-toggle="modal" onclick="edit_business_type('<?php echo base64_encode($data['id']); ?>');"> <i class="glyphicon glyphicon-edit"></i></a>
...
$.ajax({
                url: "<?php echo site_url() . 'BusinessType/add' ?>",
                type: "POST",
                dataType: "html",
   ...
   function edit_business_type(id)
        {
            ...
            $('#model_data').html('');
            $.ajax({
                url: "<?php echo site_url() . 'BusinessType/update' ?>",
                type: "POST",
                dataType: "html",
