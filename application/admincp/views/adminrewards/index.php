...
<link rel="shortcut icon" href="<?php echo base_url(); ?>/assets/imagessm-logo.png">


<div class="content">
    <div class="">
        <div class="page-header-title">
            <h4 class="page-title">Admin Rewards</h4>
        </div>
    </div>
                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-body">
                            ...
                            <h4 class="m-b-30 m-t-0">Admin Rewards</h4>
				<div class="row">
...
<script type="text/javascript">
    function load_data(){
        var table = jQuery('#datatables').DataTable({
            ...
            "order": [[0, "DESC"]],
            "ajax": {
                url: "<?php echo site_url('Adminwallet/getrewardsdata'); ?>",
                 type: "GET",
                data: function (d) {
            ...
            "columns": [
                ...
                {"taregts": 3, render: function (data, type, row) {
                 ...
                 {"taregts": 2, render: function (data, type, row) {
                        ...
                        return row.email + '(' + row.referer_code +')' ;
                    }

                },
                
                {"taregts": 3, 'data': 'created_datetime',
