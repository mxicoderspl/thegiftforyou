...
class Setting extends My_Controller {
    ...
    public function index() {
        ...
        $this->data['settings'] =$this->common->select_data_by_condition('settings', array('type' => 'Setting','status'=>'Enable'), '*', '', '', '', '', array()); //$this->common->get_all_record('settings', '*', 'setting_id', 'ASC');
