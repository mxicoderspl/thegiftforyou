                                                    ...
                                                    foreach ($business as $business) {
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="all-bx">
                                                                ...
                                                                <div class="frame"> <img class="img-fluid" src="<?php echo base_url(); ?>/uploads/business/thumb/<?php echo $business->image ?>"/> <span class="type-services"><?php echo $business->type_name ?></span>
                                                                    <div class ="details">
                                                                        <h4><i class="fas fa-map-marker-alt"></i>&nbsp;&nbsp;<?php echo $business->addressline1 . ' ' . $business->CN . ' ' . $business->SN ?></h4>
                                                                    </div>
                                                                </div>
                                                                <div class="full-info">
                                                                    <p class="u-name"><a href=""><?php echo $business->ownername ?></a></p>
                                                                    <p class="u-service"><?php echo $business->type_name ?></p>
...
<?php } ?>
                                            ...
                                            <!--                                            <div class="pagination1 col-12 float-left">
                                            ...
                                            <nav aria-label="Page navigation example">
                                                ...
                                                <div  id="pagination1">
						<?php if(isset($links)){ echo $links; } ?></a>
                                                </div>
                                                <!--
                                    ...
                                    <script type="text/javascript">
									    ...
									    $('#pagination1').show();
                                                                            $('#result').empty();
                                                                            $('#pagination1').empty();
                                                                            $('#pagination1').append(data.pagination);
//                                                                            alert(data.result.length);
                                                                            ...
                                                                            for(var i=0;i < data.result.length;i++){
                                                                                $('#postdiv').append('<div class="col-md-4">'
                                                                                    ...
                                                                                    + '<div class="frame"> <img class="img-fluid" src="<?php echo base_url(); ?>/uploads/business/thumb/'+ data.result[i].image +'"/> <span class="type-services"><?php echo $business['type_name'] ?></span>'
                                                                                    + '<div class ="details">'
                                                                                    ...
                                                                                    + '<p class="u-service">'+ data.result[i].type_name +'</p>'
                                                                                    + '<a href="" class="full-info-btn">View Full Info</a> </div>'
                                                                                    + '</div>'
                                                                                    + '</div>');
                                                                            }
