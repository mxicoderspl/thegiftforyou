...
<li class="nav-item"> <a class="nav-link" data-toggle="modal" href="" data-target="#contact">Contact Us</a> </li>-->
					 ...
					 <!--- loader --------->
                                    ...
                                    <section class="bx-wi">
                                        <div class="container">
                                            <div class="b-top-bottom">
                                                <div class="row">
                                                    <div class="col-12" >
                                                        <div class="total-result" id="results">
                                                          <p><span  id="nodata"></span> Result Found</p>
                                                        </div>
                                                        <div class="float-right">
                                                            ...
                                                            <input type="hidden" id="myview" value="1"/>
                                                            <div class="float-left pt-3">
                                                                <div class="form-group">
                                                                    <button class="cstm-t-box grid1"><i class="fa fa-th"></i></button>
                                                                </div>
                                                            </div>
                                                            <div class="float-left pt-3">
                                                                <div class="form-group">
                                                                    <button class="cstm-t-box list1"><i class="fa fa-th-list"></i></button>
                                                                </div>
                                                            </div>
                                                        </div></div>
                                                </div>
                                            ...
                                            <?php //if ($business) { ?>
                                                <nav aria-label="Page navigation example" id="pagination12">
                                    ...
                                    <?php
                                    $this->minify->js(array('jquery-1.11.1.min.js', 'bootstrap.min.js', 'fontawesome-all.min.js', 'wow.min.js','ajax-loading.js'));
                                    ...
                                    <script type="text/javascript">
                                        ...
                                        $('button').on('click', function (e) {
                                            if ($(this).hasClass('grid1')) {
                                                //1 for grid and 0 for list
                                                $('#myview').val('1');
                                                pageno = $('#page_no').val();
                                                get_data(pageno);
                                            } else if ($(this).hasClass('list1')) {
                                                $('#myview').val('0');
                                                pageno = $('#page_no').val();
                                                get_data(pageno);
                                            }
                                        ...
                                        $(document).ready(function () {
                                            ...
                                            $('#pagination12').on('click', 'a', function (e) { //alert('helo pagination');
                                                e.preventDefault();
                                        ...
                                        function get_data(pageno) {
                                            ...
                                            $.ajax({
                                                url: '<?php echo site_url('ServiceFinder'); ?>/getfiltered/' + pageno,
						beforeSend: function() {
              $("#ajaxLoading1").show();
           },
                                                data: {
                                                        ...
                                                        if ($('#myview').val() == 1) {
                                                            for (var i = 0; i < data.result.length; i++) {
                                                                $('#postdiv').append('<div class="col-md-4">'
                                                                        ...
                                                                        + '<div class="frame"> <img class="img-fluid" src="<?php echo base_url() . $this->config->item('upload_path_business'); ?>' + data.result[i].image + '" style="height:300px"/> <span class="type-services">' + data.result[i].type_name + '</span>'
                                                                        + '<div class ="details">'
                                                            ...
                                                            $('#postdiv').empty();
                                                            for (var i = 0; i < data.result.length; i++) {
                                                                $('#postdiv').append('<div class="col-md-12 list-item">'
                                                                        + '<div class="all-bx">'
                                                                        + '<div class="frame col-md-4 float-left  padng_rmv"> <img class="img-fluid " src="<?php echo base_url() . $this->config->item('upload_path_business'); ?>' + data.result[i].image + '" style="height:300px"> <span class="type-services">' + data.result[i].type_name + '</span>'
                                                                        + '<div class="details">'
                                                                        + '<h4><svg class="svg-inline--fa fa-map-marker-alt fa-w-12" aria-hidden="true" data-prefix="fas" data-icon="map-marker-alt" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" data-fa-i2svg=""><path fill="currentColor"></path></svg>&nbsp;&nbsp;' + data.result[i].addressline1 + ', ' + data.result[i].city + ' , ' + data.result[i].statename + '</h4>'
                                                                        + '</div>'
                                                                        + '</div>'
                                                                        + '<div class="full-info col-md-8 float-left">'
                                                                        + '<p class="u-name"><a href="">' + data.result[i].ownername + '</a></p>'
                                                                        + '<p class="u-service">' + data.result[i].businessname + '</p>'
                                                                        + '<p class="list-item-about">' + data.result[i].description + '</p></div>'
                                                                        + '</div>'
                                                                        + '</div>'
                                                                        );
                                                            }
							...
							//$('#pagination12').empty();
                                                       // } else {
                                                            ...
                                                            $('#pagination12').html(data.pagination);
								$( "li.page-item a" ).addClass( "page-link" );
								$("li.page-item.active a").css('background-color', '#00AEEF');
								$("li.page-item.active a").css('border-color', '#00AEEF');
                                                        //} 
							$("#ajaxLoading1").hide();
                                                    }
                                                }
