                ...
                <div class="panel">
			     ...
			     <img src="<?php echo base_url(); ?>/images/symbols/My Wallet.png" style=""/>
                        ...
                        <div class=" modal-body ">
                            ...
                            <h3 class="card-title pull-right"><small>Total : </small><img src="<?php echo base_url() . $this->config->item('upload_path_rupee'); ?>" style="height:18px;"/> <?php echo $wallet_balance; ?>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6" style="padding-left: 10px ; padding-right: 30px ">
			   ...
			   <img src="<?php echo base_url(); ?>/images/symbols/Company-Wallet.png" style=""/>
                        ...
                        <div class=" modal-body ">
                            ...
                            <h3 class="card-title pull-right"><small>Total : </small><img src="<?php echo base_url() . $this->config->item('upload_path_rupee'); ?>" style="height:18px;"/> <?php echo $conpanyWallet_balance; ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!--                    <h5>Are you sure you want to confirm payment?</h5>-->
                    <!--<form action="<?php // echo site_url('Companywallet/transfer')                         ?>" method="post">-->
                    <input type="hidden" name="transfer_tax" id="transfer_tax"/>
                    <div class="form-group col-md-6">
                        <label class="form-lable">Enter Mobile No:<span class="text-danger">*</span> :</label>
                        <!--<div class="col-sm-8">-->
                    ...
                    <div class="clearfix"></div>
                      <div class="form-group col-md-6">
                        <label class="form-lable">Enter Amount to Transfer <span class="text-danger">*</span> :</label>
                        <!--<div class="col-sm-8">-->
                        <input type="text" class="form-control" name="transfer_amount" id="transfer_amount" maxlength="12"/>
                        <!--</div>-->
                    </div>
                    <div class="form-group col-md-6">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3">Applied Taxes: </label>
                        <p class="col-sm-8" id="mydemo" style="margin-left:12px"></p>
                    </div>
                    <div class="clearfix"></div>
            ...
            <div class="modal-content">
                <div class="panelt panel-success-head">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="pull-right">
                            <a id="confirm_btn" href="#" onclick="confirm_transfer()" class="btn btn-success">Yes</a>
            ...
            <div class="modal-content">
                <div class="panelt panel-success-head">
                    ...
                    <div class="panel-body">
                        ...
                        <h5>Are you sure you want to transfer this Amount ?</h5>
                        <?php //echo form_open('Companywallet/transfer', array('id' => 'frmtransfer1')); ?>
                        <input type="hidden" value="" id="deleteadsid" />
                        <div class="pull-right">
                            <a id="confirm_btn" href="#" onclick="confirm_transfer1()" class="btn btn-success">Yes</a>
                            <button data-dismiss="modal" class="btn btn-default">No</button>
                        </div>
                        <?php //echo form_close(); ?>
                    </div>
...
//                                            $('#totaltax').text('Rs. ' + data.total_tax);
                                            ...
                                            $('#transfer_tax').val(data.total_tax);
                                            $('#label1').html('<label class="">Total Amount: </label>');
...
//                                                        
				      ...
				      $("#transfer_amount").keypress(function (event) {
				 ...
				 $("#mobile").keypress(function (e) {
                                    ...
                                    //$(this).val($(this).val().replace(/[^0-9\.]/g,''));
                                    if (e.which != 8 && (e.which < 48 || e.which > 57) && ((e.keyCode == 65 || e.keyCode == 86 || e.keyCode == 67) && (e.ctrlKey === true || e.metaKey === true)) ) {
                                        return false;
                                    }
                                });
                                    ...
                                    $.ajax({
                                        ...
                                        success: function (data) {
                                            ...
                                            $('#profile').append('<div class="form-group col-md-6">'
                                                    ...
                                                    + '<span class="col-md-2"><img class="img-circle" src="<?php echo base_url() . $this->config->item('upload_path_profilepic_thumb'); ?>' + data.profile.profilepic + '"style="height:45px;width:45px"/>' + '</b></span>&nbsp;&nbsp;&nbsp;'
                                                    + '<span class="col-md-8" style="padding-left:24px;padding-top:5px"><b>' + data.profile.firstname + ' ' + data.profile.lastname + '</b></span>&nbsp;&nbsp;'
