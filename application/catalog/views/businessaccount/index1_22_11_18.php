            ...
            <div class="container">
                ...
                <div class="panel col-md-12 col-xs-10">
                    <div class="panel-body">
                        ...
                        <div class="classes-tablist col-xs-12" style="margin-bottom:20px">
                        ...
                        <div class="tab-content">
                            ...
                            <div role="tabpanel" class="tab-pane" id="About">
                                <div class="col-md-12 col-xs-12">
                                    <!--<h4>Write About You And Your Company</h4>-->
                                    <div class=" col-md-12 col-xs-12">
                                        <?php echo form_open(site_url('BusinessAccount/aboutbusiness'), array('class' => '', 'id' => 'aboutfrm', 'name' => 'aboutfrm','enctype' => 'multipart/form-data','method'=>'POST')); ?>
                                        <!--<div class="form-group col-xs-12 padng_rmv">-->
                                        ...
                                        <div class="form-group col-md-12" id="business_price">
                                            <label class="col-md-2 control-label">Price <span class="text-danger">*</span></label>
                                            <div class="col-md-4">
                                                <input type="text" class="form-control" data-buttonbefore="true" id="price" name="price" tabindex="-1" >
    ...
    <script>
                                                    ...
                                                    $("#business_type").change(function () {
                                                        if($("#business_type").val()!= 2){
                                                            document.getElementById('business_price').style.display = 'none';
                                                        }else{
                                                            document.getElementById('business_price').style.display = 'block';
                                                        }
                                                        
                                                        if($("#business_type").val() == 3){
                                                            $("#businessname").val('Student');
                                                        }else{
                                                             $("#businessname").val('');
                                                        }
                                                    });
                                                    ...
                                                    $(document).ready(function () {
                                                        ...
                                                        $('#aboutfrm').validate({
                                                            ...
                                                            messages:{
                                                                image:"Please upload image for your business",
                                                                price:"Please enter Price",
                                                                description:"Please write something about related to business"
                                                            }
