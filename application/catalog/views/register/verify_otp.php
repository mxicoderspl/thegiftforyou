    ...
    <div class="container">
        <div class="row">
            <div class="col-md-5 col-xs-12 col-md-offset-3">
                ...
                <?php } ?>
                <?php echo form_open(site_url('register/verifyotp'), array('class' => 'form-horizontal', 'id' => 'otp_frm', 'method' => 'post')); ?>
                <div class="form-group">
                    <label for="" class="col-md-3"></label>
                    <div class="col-md-9">
                        <h1 class="main-title">Mobile Verification</h1>
                    </div>
                </div>
                
                <a href="<?php echo site_url("Login/change_mobile")?>" style="float: right">Change Mobile No</a>
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#otp_frm').validate({
            rules: {
                otp: {
                    required: true,
                    remote: {
                        url: "<?php echo site_url('register/verifyotp') ?>",
                        type: "post",
                        data: {
                            otp: function () {
                                return $("#otp").val();
        ...
        $('#resend_otp').on('click', function () {
            $.ajax({
                url: "<?php echo site_url('register/resendotp'); ?>",
                type: "post",
                dataType: "json",
