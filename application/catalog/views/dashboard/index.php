...
<div class="content-page">
    <div class="content">
        <div class="m-t-10">
			...
			<img src="<?php echo base_url(); ?>/images/symbols/Referal.png" />
                      </div>
                      <div class="modal-body pull-left">
                      <p class="card-category text-center"> My Referal</p>

                      </div>
					  <div class="clearfix"></div>
					  <div class="pull-left"><h4 class="card-title pull-right"><small>Total : </small> </i> <?php echo $referal[0]['total_referal']; ?>
                          <!--<small>RS</small>-->
                      </h4></div>
                  </div>
		...
		<div class="col-lg-4 col-xs-12 cstm-p">
            <div class="panel">
			  ...
			  <img src="<?php echo base_url(); ?>/images/symbols/Payouts.png" />
                      </div>
                      <div class="modal-body pull-left">
                      <p class="card-category text-center"> PayOuts</p>
					  </div>
					   <div class="clearfix"></div>
					   <div class="col-xs-12 padng_rmv">
                      <h4 class="card-title pull-left">
                          <small>Withdrawn : </small><i class="fa fa-inr font-16"></i> <?php echo $totaldeposite[0]['totaldeposite']; ?>
                      </h4>
		      <h4 class="card-title pull-right">
                          <small>Available : </small><i class="fa fa-inr font-16"></i> <?php echo $wallet_balance; ?>
                      </h4>
...
<div class="col-lg-4 col-xs-12 cstm-p">
			...
			<img src="<?php echo base_url(); ?>/images/symbols/Balance1.png" />
                      </div>
                      <div class=" modal-body pull-left">
                      <p class="card-category text-center">Balance</p>
					  </div>
					  <div class="clearfix"></div>
					  <div class="col-xs-12 padng_rmv">
                      <h4 class="card-title pull-left">
                          <small>Wallet : </small><i class="fa fa-inr font-16"></i>  <?php echo $wallet_balance; ?>
                      </h4>
			<h4 class="card-title pull-right">
                          <small>Company Wallet : </small><i class="fa fa-inr font-16"></i>  <?php echo $balance[0]['company_wallet_balance']; ?>
                      </h4>
                      </div></div>
...
<div class="col-lg-4 col-xs-12 cstm-p">
			...
			<img src="<?php echo base_url(); ?>/images/symbols/Tickets.png" />
                      </div>
                      <div class="modal-body pull-left">
