...
class Network extends MY_Controller {
    ...
    public function __construct() {
        ...
        $this->data['title'] = $this->data['site_name'] . ': Network';
...
//echo $level;die();
        ...
        $getfiled = "user_reward.id,user_reward.amount,user_reward.created_datetime,user.email,user.profilepic,user.firstname,user.lastname";
